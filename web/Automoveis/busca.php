            ...
            <ul class="meio">
                ...
                <li>
                    <ul class="carros">
                        ...
                        //$tipo_carro = $_REQUEST['tipo_carro'];
                        ...
                        //$sqlc = mysql_query("SELECT * FROM Veiculo where (Descricao like '%$palavra%' or cidade like '%$cidade%' or marca like '%$marca%' or modelo like '%$modelo%' or (ano BETWEEN $ano AND $ano2) or (Valor BETWEEN $preco AND $preco2) or (Km BETWEEN $km AND $km2))");

                        $sqlc = mysql_query("SELECT * FROM Veiculo where (Descricao like '%$palavra%' or (Ano BETWEEN $ano AND $ano2) or (Valor BETWEEN $preco AND $preco2) or (Km BETWEEN $km AND $km2))");
